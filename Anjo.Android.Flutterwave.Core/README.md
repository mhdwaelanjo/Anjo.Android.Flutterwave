# Anjo.Android.Flutterwave.Core

---------------------------------
Flutterwave.Core SDK for .NET Android (formerly Xamarin.Android) bindings for AndroidX library - Wael Anjo
---------------------------------

[![NuGet Version](https://img.shields.io/nuget/v/Anjo.Android.Flutterwave.Core)](https://www.nuget.org/packages/Anjo.Android.Flutterwave.Core) [![GitHub License](https://img.shields.io/github/license/mhdwaelanjo/Anjo.Android.Flutterwave)](https://github.com/mhdwaelanjo/Anjo.Android.Flutterwave/blob/master/LICENSE.txt)
...
- Quickstart for Android : https://developer.flutterwave.com/docs/quickstart & https://github.com/Flutterwave/AndroidSDK

- Star on Github if this project helps you: https://github.com/mhdwaelanjo/Anjo.Android.Flutterwave
