# Anjo.Android.Flutterwave.Remote

---------------------------------
Flutterwave.Remote SDK for .NET Android (formerly Xamarin.Android) bindings for AndroidX library - Wael Anjo
---------------------------------

[![NuGet Version](https://img.shields.io/nuget/v/Anjo.Android.Flutterwave.Remote)](https://www.nuget.org/packages/Anjo.Android.Flutterwave.Remote) [![GitHub License](https://img.shields.io/github/license/mhdwaelanjo/Anjo.Android.Flutterwave)](https://github.com/mhdwaelanjo/Anjo.Android.Flutterwave/blob/master/LICENSE.txt)
